  ...
  if (!blueprint) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-12 text-center">
        <h2 className="text-xl font-bold text-red-600 font-display">
          Blueprint not found
        </h2>
        <Link
          href="/blueprints"
      ...
      <div className="bg-white rounded-xl border border-[#E1E4EA] p-8 shadow-sm min-h-[300px] space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4 rounded-xl border border-slate-100 bg-slate-50/50">
              <h3 className="font-bold text-[#181B20] font-display text-sm">
                {blueprint.architectureFlow?.architecture?.title ||
                  'Architecture'}
              </h3>
            ...
            <div className="p-4 rounded-xl border border-slate-100 bg-slate-50/50">
              <h3 className="font-bold text-[#181B20] font-display text-sm">
                {blueprint.architectureFlow?.plan?.title ||
                  'Implementation Plan'}
              </h3>
              <p className="text-xs text-[#6B7280] mt-2 leading-relaxed">
        ...
        <div className="pt-6 border-t border-[#E1E4EA] grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
          ...
          <div>
            ...
            <p className="text-[#6B7280] mt-1">{blueprint.complexcity} Level</p>
          </div>
        </div>
      </div>
    </div>
