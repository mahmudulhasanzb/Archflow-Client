    ...
    <div className="min-h-screen bg-background text-foreground py-16 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl space-y-16">
        ...
        <section className="space-y-6">
          ...
          {/* Interactive Specification Output Explorer */}
          <div className="pt-6">
            <div className="mb-4">
              <h3 className="text-lg font-bold text-foreground">Interactive Specification Output</h3>
              <p className="text-xs text-muted-foreground mt-0.5">
                Explore an authentic sample output bundle generated by Archflow:
              </p>
            </div>
            <SpecPreviewTerminal />
          </div>
